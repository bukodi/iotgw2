...
export default class MessageType extends Vue {
  ...
  public retrieveAllMessageTypes(): void {
  ...
  public prepareRemove(instance: IMessageType): void {
  ...
  public removeMessageType(): void {
    this.messageTypeService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('iotgw2App.messageType.deleted', { param: this.removeId });
