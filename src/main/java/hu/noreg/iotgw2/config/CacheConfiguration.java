package hu.noreg.iotgw2.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hu.noreg.iotgw2.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hu.noreg.iotgw2.repository.UserRepository.USERS_BY_EMAIL_CACHE);
